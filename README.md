...
* **הוספת קישור או מערכת**: ממשק ניהול > קישורים ומשאבים > הוספה. בוחרים סוג (מערכת, נוהל, טופס, מסמך, קישור), קטגוריה, אייקון, תפקידים מורשים. מסמנים "גישה מהירה" כדי שיופיע בדף הבית של הצוות.
